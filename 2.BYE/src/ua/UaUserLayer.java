...
public class UaUserLayer {
 ...
 // ¿Estoy actualmente EN llamada?
    ...
    public void onInviteOKFromCallee(OKMessage ok) {
        ...
        currentRemoteUri    = ok.getFromUri();     // el que responde (callee)
    ...
    private void sendByeCommand() throws IOException {
        ...
        if (currentCallId == null || currentRemoteUri == null || currentRemoteContact == null) {
            System.out.println("Error interno: información de llamada incompleta, no envío BYE.");
            return;
        }

        // IP y puerto del otro UA a partir del Contact que guardamos
        ...
        // Request-URI = remoto
        bye.setDestination(currentRemoteUri);
        ...
        // To / From
        bye.setToName(null); // opcional, si quieres luego parseas el nombre
